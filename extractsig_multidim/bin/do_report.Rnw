...
Figure<-function(figname,scale, title='')paste('\\begin{subfigure}{',scale+0.05,'\\textwidth}\\centering\\includegraphics[width=',scale*20,'cm]{', figname,'}\\caption{',title,'}\\label{fig:',figname,'}\\end{subfigure}',sep='')
infocol=gsub('_',' ', infocol)
scale=1/nbcol-0.05
